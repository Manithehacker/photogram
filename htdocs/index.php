  ...
  <body>
    ...
    <header class="header">
      <nav class="nav bd_grid">
        <div>
          <a href="#" class="nav_logo">MANIKANDAN</a>
        </div>
        ...
        <div class="nav_menu" id="nav_menu">
          <ul class="nav_list">
            ...
            <li class="nav_items">
              <a href="about.php" class="nav_link active">About</a>
            </li>
            <li class="nav_items">
              <a href="skills.php" class="nav_link active">Skills</a>
            </li>
            <li class="nav_items">
              <a href="service.php" class="nav_link active">service</a>
            </li>
            <li class="nav_items">
              <a href="contact.php" class="nav_link active">Contact</a>
            </li>
          </ul>
        </div>
    ...
    <main class="main">
      ...
      <section class="home bd_grid" id="home">
        <div class="home_data" data-aos="fade-down">
          <h1 class="home_title">
            Hi, <br />I'm <span class="home_title-color">Manikandan</span>
            <br />Web Designer, </br>
             Ethical hacker
          </h1>
      ...
      <!--
      <footer class="footer">
        <p class="footer_title" data-aos="fade-down">MANIKANDAN</p>
